#*********************************************************
#  synthesize script for cell: checkmask                  *
#*********************************************************
...
define_design_lib MY_LIB -path /tmp/tqiu/Documents/CheckMask/syn_work
define_design_lib CELLSLIB -path /data/public/common/software/opprog/synth_libs/CellsLib
read_file -format vhdl -work MY_LIB {/tmp/tqiu/Documents/CheckMask/VHDL/CheckMask.vhd /tmp/tqiu/Documents/CheckMask/VHDL/CheckMask_behaviour.vhd}
...
report_area
report_fsm
write_file -f ddc checkmask -output /tmp/tqiu/Documents/CheckMask/ADB/checkmask.ddc
write_file -f vhdl checkmask -output /tmp/tqiu/Documents/CheckMask/VHDL/checkmask_SYNTH.vhd
quit
