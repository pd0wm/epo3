extern network score (terminal clk, rst, increase_value_2_0_2, 
                               increase_value_2_0_1, increase_value_2_0_0, 
                               increase, output_7_0_7, output_7_0_6, 
...
network log_score (terminal clk, rst, increase, increase_value_2_0_2, 
                            increase_value_2_0_1, increase_value_2_0_0, 
                            output_7_0_7, output_7_0_6, output_7_0_5, 
                            output_7_0_4, output_7_0_3, output_7_0_2, 
                            output_7_0_1, output_7_0_0, vss, vdd)
{
   {L1} score (clk, rst, increase_value_2_0_2, increase_value_2_0_1, 
               increase_value_2_0_0, increase, score_to_log_7_port, 
               score_to_log_6_port, score_to_log_5_port, score_to_log_4_port, 
               score_to_log_3_port, score_to_log_2_port, score_to_log_1_port, 
               score_to_log_0_port, vss, vdd);
