...
set link_library [list "*" "./ADB/log.ddc" "./ADB/score.ddc" "/data/public/common/software/opprog/synth_libs/g_digilib5_99.db" "/data/public/common/software/opprog/synth_libs/g_analib8_00.db" "/data/public/common/software/opprog/synth_libs/buffers.db"]
...
read_file -format vhdl -work MY_LIB {VHDL/log_score.vhd VHDL/log_score-behaviour.vhd}
...
report_area
report_fsm
write_file -f ddc log_score -output ./ADB/log_score.ddc
write_file -f vhdl log_score -output ./VHDL/log_score_SYNTH.vhd
quit
