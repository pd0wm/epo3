...
define_design_lib MY_LIB -path /tmp/tqiu/Desktop/epo3/LUT/syn_work
define_design_lib CELLSLIB -path /data/public/common/software/opprog/synth_libs/CellsLib
read_file -format vhdl -work MY_LIB {/tmp/tqiu/Desktop/epo3/LUT/VHDL/piece_lut.vhd /tmp/tqiu/Desktop/epo3/LUT/VHDL/piece_lut-behaviour.vhd}
...
report_area
report_fsm
write_file -f ddc piece_lut -output /tmp/tqiu/Desktop/epo3/LUT/ADB/piece_lut.ddc
write_file -f vhdl piece_lut -output /tmp/tqiu/Desktop/epo3/LUT/VHDL/piece_lut_SYNTH.vhd
quit
