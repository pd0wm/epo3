...
network adder_y (terminal y_3_0_3, y_3_0_2, y_3_0_1, y_3_0_0, rom_data_3_0_3, 
                          rom_data_3_0_2, rom_data_3_0_1, rom_data_3_0_0, 
                          next_piece, y_out_4_0_4, y_out_4_0_3, y_out_4_0_2, 
                          y_out_4_0_1, y_out_4_0_0, vss, vdd)
{
   ...
   {U36} na310 (rom_data_3_0_2, n37, y_3_0_0, n36, vss, vdd);
   {U37} na210 (rom_data_3_0_3, y_3_0_1, n35, vss, vdd);
   {U38} ex210 (n38, n30, y_out_4_0_1, vss, vdd);
   {U39} ex210 (n39, n37, n30, vss, vdd);
   {U40} ex210 (rom_data_3_0_3, y_3_0_1, n37, vss, vdd);
   {U41} na210 (y_3_0_0, rom_data_3_0_2, n39, vss, vdd);
   {U42} na210 (n38, n40, y_out_4_0_0, vss, vdd);
   {U43} na210 (n31, n34, n40, vss, vdd);
   {U44} iv110 (n29, n38, vss, vdd);
   {U45} no210 (n34, n31, n29, vss, vdd);
   {U46} ex210 (y_3_0_0, rom_data_3_0_2, n31, vss, vdd);
   {U47} na310 (rom_data_3_0_2, n41, next_piece, n34, vss, vdd);
   {U48} iv110 (rom_data_3_0_3, n41, vss, vdd);
}
