...
network vga_np_trans (terminal clk, rst, mem_addr_reset_in_1_0_1, 
                               mem_addr_reset_in_1_0_0, mem_addr_out_7_0_7, 
                               ...
                               new_frame_in, vss, vdd)
{
   {mem_addr_counter} vga_counter_8bitset (clk, rst, X_Logic0_port, 
                                           mem_addr_enable, n9, X_Logic1_port, 
                                           X_Logic0_port, X_Logic0_port, 
                                           X_Logic0_port, 
                                           mem_addr_reset_in_1_0_1, 
   ...
   {U33} na210 (in_np_in, counter_state_0_port, n19, vss, vdd);
   {U34} ex210 (in_np_in, counter_state_0_port, N16, vss, vdd);
}
