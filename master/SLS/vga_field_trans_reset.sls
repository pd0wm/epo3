extern network vga_counter_4bit (terminal clk, rst, rst_ext, en, val_3_0_3, 
                                          val_3_0_2, val_3_0_1, val_3_0_0, vss, 
                                          vdd)
...
network vga_field_trans_reset (terminal clk, rst, mem_addr_reset_out_3_0_3, 
                                        ...
                                        vdd)
{
   {mem_addr_counter} vga_counter_4bit (clk, rst, end_frame_in, 
                                        mem_addr_enable, 
                                        mem_addr_reset_out_3_0_3, 
                                        mem_addr_reset_out_3_0_2, 
                                        mem_addr_reset_out_3_0_1, 
                                        mem_addr_reset_out_3_0_0, vss, vdd);
