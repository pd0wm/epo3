extern network vga_counter_5bit (terminal clk, rst, rst_ext, en, val_4_0_4, 
                                          val_4_0_3, val_4_0_2, val_4_0_1, 
                                          val_4_0_0, vss, vdd)
...
network vga_field_trans_reset (terminal clk, rst, mem_addr_reset_out_7_0_7, 
                                        ...
                                        vdd)
{
   ...
   net {mem_addr_reset_out_7_0_2, X_Logic0_port};
   net {mem_addr_reset_out_7_0_1, X_Logic0_port};
   net {mem_addr_reset_out_7_0_0, X_Logic0_port};
   {mem_addr_counter} vga_counter_5bit (clk, rst, end_frame_in, 
                                        mem_addr_enable, 
                                        mem_addr_reset_out_7_port, 
                                        mem_addr_reset_out_6_port, 
                                        mem_addr_reset_out_5_port, 
                                        mem_addr_reset_out_4_port, 
   ...
   {U43} na210 (end_field_line_in, n38, n36, vss, vdd);
   ...
   {U53} na210 (end_field_line_in, counter_state_0_port, n43, vss, vdd);
   {U54} mu111 (n34, n28_port, counter_state_0_port, N24, vss, vdd);
   {U55} iv110 (end_field_line_in, n28_port, vss, vdd);
   {U56} iv110 (n39, n34, vss, vdd);
   {U57} na210 (end_field_line_in, n47, n39, vss, vdd);
