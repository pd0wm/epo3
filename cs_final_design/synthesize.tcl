#*********************************************************
#  synthesize script for cell: cs_adder7                  *
#*********************************************************
...
read_file -format vhdl -work MY_LIB {VHDL/cs_adder7.vhd VHDL/cs_adder7_arch.vhd}
...
report_area
report_fsm
write_file -f ddc cs_adder7 -output ./ADB/cs_adder7.ddc
write_file -f vhdl cs_adder7 -output ./VHDL/cs_adder7_SYNTH.vhd
quit
