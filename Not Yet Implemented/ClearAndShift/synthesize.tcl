#*********************************************************
#  synthesize script for cell: clearandshift              *
#*********************************************************
...
define_design_lib MY_LIB -path /tmp/sandervandijk/EPO3/ClearAndShift/syn_work
define_design_lib CELLSLIB -path /data/public/common/software/opprog/synth_libs/CellsLib
read_file -format vhdl -work MY_LIB {/tmp/sandervandijk/EPO3/ClearAndShift/VHDL/clearandshift.vhd /tmp/sandervandijk/EPO3/ClearAndShift/VHDL/clearandshift-clearandshift_behaviour.vhd}
...
report_area
report_fsm
write_file -f ddc clearandshift -output /tmp/sandervandijk/EPO3/ClearAndShift/ADB/clearandshift.ddc
write_file -f vhdl clearandshift -output /tmp/sandervandijk/EPO3/ClearAndShift/VHDL/clearandshift_SYNTH.vhd
quit
